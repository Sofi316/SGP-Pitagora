...
const ClientUsuarioDetalle = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Reconstruimos el payload enviando también los datos que el cliente 
      // no puede editar, para que el backend no los borre.
      const payload = {
        ...usuario, 
  ...
  // ESTILOS EN LÍNEA PARA EL MODAL (Iguales a ModalEditarUsuario)
  ...
  return (
    <div className={styles.container}>
      ...
      {/* TARJETA PRINCIPAL (Igual a DetalleUsuario) */}
      ...
      {/* MODAL DE EDICIÓN LIMITADO A LOS 5 CAMPOS */}
      {showModal && (
        <div style={sOverlay}>
          <div style={sContent}>
